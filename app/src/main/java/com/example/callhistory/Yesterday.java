...
public class Yesterday extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        readContactNamesAndCallCountsForYesterday();
...
// Show the ProgressDialog
        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if (item.getItemId() == R.id.menu_option_1) {
                    ...
                    startActivity(new Intent(Yesterday.this,TodayActivity.class));
                    finish();

                    return true;
                } else if (item.getItemId() == R.id.menu_option_2) {
                    startActivity(new Intent(Yesterday.this,Yesterday.class));
                    finish();
                    return true;
                } else if (item.getItemId() == R.id.menu_option_3) {
                    startActivity(new Intent(Yesterday.this,Week.class));
                    finish();
                    return true;
                } else if (item.getItemId() == R.id.menu_option_4) {
                    startActivity(new Intent(Yesterday.this,month.class));
                    finish();
                    return true;
                } else if (item.getItemId() == R.id.menu_option_5) {
                    startActivity(new Intent(Yesterday.this,year.class));
                    finish();
                    return true;
                }else if (item.getItemId() == R.id.menu_option_6) {
                    startActivity(new Intent(Yesterday.this,MainActivity.class));
                    finish();
                    return true;
                } else {
    ...
    private void readCallLogDataForCurrentDate() {
        ...
        // Query call log data for yesterday
        Cursor cursor = getContentResolver().query(
                CallLog.Calls.CONTENT_URI,
                null,
                CallLog.Calls.DATE + " >= ? AND " + CallLog.Calls.DATE + " < ?",
                new String[]{String.valueOf(getStartOfDayInMillis(1)), String.valueOf(getStartOfDayInMillis(0))},
                null
        );
     /*   // Query call log data for the current date
        ...
        if (cursor != null) {
            ...
            while (cursor.moveToNext()) {
                ...
                if (callDate.equals(yesterdayDate)) {
                    // Call belongs to yesterday, update statistics
...
// Refresh the chart
    ...
    private void readContactNamesAndCallCountsForYesterday() {
        ...
        if (cursor != null) {
            ...
            while (cursor.moveToNext()) {
                ...
                if (callDate.equals(yesterdayDate) && callerName != null && !callerName.isEmpty()) {
                    // Call belongs to yesterday and has a caller name
